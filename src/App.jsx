...
const T = {
  en: {
    ...
    contact: { title: "Contact Us", sub: "Questions or partnership ideas? We are based between the UK and Uzbekistan.", email: "Email", emailV: "abdulaziz.ruzmatov@northumbria.ac.uk", resp: "Response time", respV: "Within 24 hours", serving: "Serving", servingV: "UK & Uzbekistan only", formTitle: "Send a message", formSub: "We read every message and reply personally.", nameL: "Name *", emailL: "Email *", countryL: "Country", msgL: "Message *", send: "Send Message →" },
  ...
  uz: {
    ...
    contact: { title: "Biz bilan bog'laning", sub: "Savollar yoki hamkorlik g'oyalari? Biz UK va O'zbekiston o'rtasida joylashganmiz.", email: "Elektron pochta", emailV: "abdulaziz.ruzmatov@northumbria.ac.uk", resp: "Javob vaqti", respV: "24 soat ichida", serving: "Xizmat ko'rsatish", servingV: "Faqat UK va O'zbekiston", formTitle: "Xabar yuboring", formSub: "Har bir xabarni o'qiymiz va shaxsan javob beramiz.", nameL: "Ism *", emailL: "Elektron pochta *", countryL: "Mamlakat", msgL: "Xabar *", send: "Xabar yuborish →" },
