...
// Add VITE_ANTHROPIC_KEY to your .env file for AI chat
// ⚠️ For production, proxy through a Supabase Edge Function instead of calling Anthropic directly
...
const T = {
  en: {
    nav: { browse: "Browse", blog: "Blog", contact: "Contact", share: "+ Share a Mistake", login: "Sign In", logout: "Sign Out", register: "Register" },
    ...
    detail: { lesson: "✅ Lesson Learned", comments: "Comments", noComments: "No comments yet.", commentPh: "Add a comment...", post: "Post", reviews: "⭐ Reviews", noReviews: "No reviews yet.", writeReview: "Write a Review", reviewPh: "Share your thoughts on this case...", submitReview: "Post Review", loginReview: "Sign in to write a review", lossLabel: "💸 Total Loss" },
    ...
    auth: { loginTitle: "Welcome Back", regTitle: "Create Account", email: "Email *", password: "Password *", name: "Your Name *", company: "Company / Business", country: "Country", loginBtn: "Sign In", regBtn: "Create Account", switchToReg: "Don't have an account? Register →", switchToLogin: "Already have an account? Sign in →", verifyNote: "Please verify your email after signing up.", resendVerify: "Resend verification email", verified: "✓ Verified", notVerified: "Email not verified" },
    toast: { published: "✓ Published! Your mistake could save someone's business.", comment: "Comment posted!", contact: "✓ Message sent! We'll reply within 24 hours.", blogPublished: "✓ Blog post published!", fill: "Please fill in all required fields.", loginSuccess: "Welcome back!", regSuccess: "Account created! Check your email to verify.", loggedOut: "Signed out.", reviewPosted: "Review posted!", verifyResent: "Verification email resent." },
    impact: { high: "High", medium: "Medium", low: "Low" },
    chat: { title: "AI Business Advisor", placeholder: "Ask about business mistakes, failures, advice...", send: "Send", thinking: "Thinking...", open: "Ask AI", close: "Close", welcome: "Hi! I'm your AI business advisor. I can help you understand common business mistakes and how to avoid them based on real cases shared here. What would you like to know?" },
  ...
  uz: {
    nav: { browse: "Ko'rish", blog: "Blog", contact: "Aloqa", share: "+ Xatoni ulashing", login: "Kirish", logout: "Chiqish", register: "Ro'yxatdan o'tish" },
    ...
    topCases: { title: "💸 Katta zarar holatlari", sub: "$100k+ zarar ko'rgan biznes muvaffaqiyatsizliklari", noData: "Hali $100k+ holat yo'q." },
    form: { title: "Biznes xatosini ulashing", sub: "Hikoyangiz boshqa birovning biznesini saqlab qolishi mumkin.", industry: "Soha *", country: "Mamlakat *", ptitle: "Nima noto'g'ri ketdi? *", problem: "Nima bo'ldi? *", lesson: "O'rganilgan dars *", impact: "Ta'sir", name: "Ismingiz", namePh: "Anonim", cancel: "Bekor qilish", publish: "Nashr etish →", loss: "Zarar miqdori ($)", lossph: "masalan: 50000", image: "Rasm yuklash (ixtiyoriy)", industries: ["Moda va chakana savdo","Texnologiya va SaaS","Oziq-ovqat va restoran","Marketing va agentlik","Moliya va bank","Elektron tijorat","Ishlab chiqarish","Ta'lim","Sog'liqni saqlash","Sayohat va turizm","Ko'chmas mulk","Boshqa"], high: "🔴 Yuqori — deyarli halokatli", medium: "🟡 O'rtacha — katta to'siq", low: "🟢 Past — kichik lekin foydali", selectInd: "Sohani tanlang", selectCou: "Mamlakatni tanlang" },
    detail: { lesson: "✅ O'rganilgan dars", comments: "Izohlar", noComments: "Hali izoh yo'q.", commentPh: "Izoh qo'shing...", post: "Yuborish", reviews: "⭐ Sharhlar", noReviews: "Hali sharh yo'q.", writeReview: "Sharh yozing", reviewPh: "Bu holat haqida fikringizni ulashing...", submitReview: "Sharh jo'natish", loginReview: "Sharh yozish uchun kiring", lossLabel: "💸 Umumiy zarar" },
    ...
    contact: { title: "Biz bilan bog'laning", sub: "Savollar yoki hamkorlik g'oyalari?", email: "Elektron pochta", emailV: "hello@mistakemap.co.uk", resp: "Javob vaqti", respV: "24 soat ichida", serving: "Xizmat ko'rsatish", servingV: "Faqat UK va O'zbekiston", formTitle: "Xabar yuboring", formSub: "Har bir xabarni o'qiymiz.", nameL: "Ism *", emailL: "Elektron pochta *", countryL: "Mamlakat", msgL: "Xabar *", send: "Xabar yuborish →" },
    auth: { loginTitle: "Xush kelibsiz", regTitle: "Hisob yaratish", email: "Elektron pochta *", password: "Parol *", name: "Ismingiz *", company: "Kompaniya / Biznes", country: "Mamlakat", loginBtn: "Kirish", regBtn: "Hisob yaratish", switchToReg: "Hisobingiz yo'qmi? Ro'yxatdan o'ting →", switchToLogin: "Hisobingiz bormi? Kiring →", verifyNote: "Ro'yxatdan keyin emailingizni tasdiqlang.", resendVerify: "Tasdiqlash emailini qayta yuborish", verified: "✓ Tasdiqlangan", notVerified: "Email tasdiqlanmagan" },
    toast: { published: "✓ Nashr etildi!", comment: "Izoh qo'shildi!", contact: "✓ Xabar yuborildi!", blogPublished: "✓ Blog posti nashr etildi!", fill: "Iltimos, barcha maydonlarni to'ldiring.", loginSuccess: "Xush kelibsiz!", regSuccess: "Hisob yaratildi! Emailingizni tekshiring.", loggedOut: "Chiqildi.", reviewPosted: "Sharh qo'shildi!", verifyResent: "Tasdiqlash emaili qayta yuborildi." },
    impact: { high: "Yuqori", medium: "O'rtacha", low: "Past" },
    chat: { title: "AI Biznes Maslahatchisi", placeholder: "Biznes xatolari, muvaffaqiyatsizliklar haqida so'rang...", send: "Yuborish", thinking: "O'ylamoqda...", open: "AI so'rash", close: "Yopish", welcome: "Salom! Men sizning AI biznes maslahatchingizman." },
    failAnim: { title: "Har kuni bizneslar yopiladi", sub: "Statistika bo'lmang. O'tganlardan o'rganing.", stat1: "90% startuplar yopiladi", stat2: "38% naqd pul tugaydi", stat3: "35% bozor yo'q", stat4: "$1.4M o'rtacha zarar", stat5: "20% 1-yilda yopiladi", cta: "Haqiqiy $100k+ holatlarni ko'ring →" },
  }
};
...
function MoneyParticle({ style }) {
  ...
  return (
    <div style={{
      ...
      animation: `moneyFall ${3 + Math.random() * 4}s linear infinite`,
...
// ── STARTUP FAIL ANIMATION SECTION ──
function StartupFailSection({ t, onCtaClick }) {
  ...
  return (
    <div style={{
      ...
      {particles.map(i => (
        <MoneyParticle key={i} style={{ left: `${(i / 18) * 100}%` }} />
      ))}
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        }}>⚠ Business Failure Reality Check</div>
        ...
        <button
          ...
          style={{
            ...
            boxShadow: "0 8px 30px rgba(229,62,62,0.35)",
            animation: "fadeUp 0.6s 0.5s ease both",
          }}
        >{t.failAnim.cta}</button>
      </div>
    </div>
  );
}
...
function TopCasesSection({ t, problems, onOpen, votedIds, onUpvote }) {
  const top = problems
    .filter(p => p.loss_amount && p.loss_amount >= 100000)
  ...
  return (
    <div id="top-cases" style={{ background: "#fff9f9", borderTop: "1px solid #ffe0e0", padding: "2.5rem 1.5rem" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        {top.length === 0 ? (
          <p style={{ textAlign: "center", color: "#aaa", fontSize: "0.86rem" }}>{t.topCases.noData}</p>
        ) : (
              ...
              >
                ...
                <div style={{ padding: "1rem" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "0.75rem" }}>
                    ...
                    <button onClick={e => { e.stopPropagation(); onUpvote(p.id, e); }}
                      style={{ background: votedIds.has(p.id) ? GREEN : "#f0f7f0", color: votedIds.has(p.id) ? "#fff" : GREEN, border: `1px solid ${votedIds.has(p.id) ? GREEN : "#c8dfc8"}`, borderRadius: 5, padding: "0.22rem 0.55rem", fontSize: "0.74rem", fontWeight: 600, cursor: "pointer", fontFamily: "Inter,sans-serif" }}>
                      ▲ {p.upvotes}
                    </button>
                  </div>
                </div>
...
function Leaderboard({ t }) {
  ...
  useEffect(() => {
    supabase.rpc("get_monthly_leaderboard").then(({ data }) => {
      if (data) setLeaders(data);
    });
  }, []);

  return (
    <div style={{ background: "#fff", border: "1px solid #dceadc", borderRadius: 12, padding: "1rem", overflow: "hidden" }}>
      <div style={{ fontSize: "0.67rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.07em", color: "#7a9a7a", marginBottom: "0.35rem" }}>{t.sidebar.leaderboard}</div>
      <div style={{ fontSize: "0.7rem", color: "#bbb", marginBottom: "0.85rem" }}>{t.sidebar.leaderboardSub}</div>
      {leaders.length === 0 ? (
        <p style={{ fontSize: "0.78rem", color: "#ccc", textAlign: "center", padding: "0.75rem 0" }}>No data yet</p>
      ) : (
        leaders.map((l, i) => (
          <div key={i} style={{
            display: "flex",
            ...
            borderRadius: 8,
            background: i === 0 ? "linear-gradient(90deg, rgba(255,215,0,0.1), transparent)" : "transparent",
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: "0.8rem", fontWeight: 700, color: "#0d3a1e", display: "flex", alignItems: "center", gap: "0.3rem" }}>
                {l.name}
                {l.is_verified && <span style={{ fontSize: "0.6rem", background: GREEN, color: "#fff", padding: "0.05rem 0.35rem", borderRadius: 100 }}>✓</span>}
              </div>
              <div style={{ fontSize: "0.69rem", color: "#9a9a9a", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                {l.company || l.country || ""}
              </div>
            </div>
      ...
      {leaders[0] && (
        <div style={{ marginTop: "0.6rem", background: "linear-gradient(135deg, #fef3c7, #fde68a)", borderRadius: 8, padding: "0.5rem 0.7rem", fontSize: "0.73rem", color: "#92400e", fontWeight: 600, textAlign: "center" }}>
          👑 Top Contributor: {leaders[0].name}
        </div>
      )}
    </div>
  );
...
function ReviewSection({ t, problemId, user }) {
  ...
  useEffect(() => {
    supabase.from("reviews").select("*").eq("problem_id", problemId).order("created_at", { ascending: false })
          ...
          <div style={{ display: "flex", gap: "0.3rem", marginBottom: "0.5rem" }}>
            {[1,2,3,4,5].map(n => (
              <button key={n} onClick={() => setRating(n)}
                style={{ background: "none", border: "none", cursor: "pointer", fontSize: "1.3rem", filter: n <= rating ? "none" : "grayscale(1) opacity(0.3)", transition: "all 0.1s" }}>⭐</button>
            ))}
          </div>
          <textarea
            value={body} onChange={e => setBody(e.target.value)}
            placeholder={t.detail.reviewPh}
            style={{ ...inpSt(), minHeight: 60, resize: "vertical", marginBottom: "0.5rem" }}
          />
          <button onClick={submit} disabled={submitting}
            style={{ background: GREEN, color: "#fff", border: "none", borderRadius: 6, padding: "0.45rem 1rem", fontWeight: 600, fontSize: "0.8rem", cursor: "pointer", fontFamily: "Inter,sans-serif", opacity: submitting ? 0.6 : 1 }}>
...
function AIChatWidget({ t, problems }) {
  ...
  const send = async () => {
    ...
    // Build context from top problems + their lessons
    const context = problems.slice(0, 8).map(p =>
      `Case: "${p.title}" (${p.industry}, ${p.country})\nProblem: ${p.problem}\nLesson: ${p.lesson}`
    ).join("\n\n");
    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 1000,
          system: `You are a helpful AI business advisor for MistakeMap — a community platform for UK and Uzbekistan entrepreneurs. 
You help users understand business mistakes and how to avoid them.
Here are some real cases shared by the community:\n\n${context}\n\nBe concise, practical, and empathetic. Respond in the same language the user writes in.`,
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          height: 52,
          borderRadius: "50%",
          background: open ? "#444" : "linear-gradient(135deg, #1a5c30, #22743c)",
          color: "#fff",
          border: "none",
          cursor: "pointer",
          fontSize: "1.4rem",
          zIndex: 300,
          boxShadow: "0 4px 20px rgba(26,92,48,0.35)",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          transition: "all 0.2s",
        ...
        <div style={{
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "0.85rem", display: "flex", flexDirection: "column", gap: "0.6rem" }}>
            {messages.map((m, i) => (
              <div key={i} style={{ display: "flex", justifyContent: m.role === "user" ? "flex-end" : "flex-start" }}>
                <div style={{
                  ...
                  background: m.role === "user" ? GREEN : "#f0f7f0",
            ...
            {loading && (
              <div style={{ display: "flex", justifyContent: "flex-start" }}>
                <div style={{ padding: "0.55rem 0.85rem", borderRadius: "12px 12px 12px 3px", background: "#f0f7f0", fontSize: "0.81rem", color: "#aaa", animation: "pulse 1.2s infinite" }}>{t.chat.thinking}</div>
              </div>
            )}
            <div ref={endRef} />
          </div>
          ...
          <div style={{ padding: "0.6rem", borderTop: "1px solid #f0f0f0", display: "flex", gap: "0.4rem" }}>
            <input
              ...
              style={{ ...inpSt({ fontSize: "0.8rem" }), flex: 1 }}
            />
            <button onClick={send} disabled={loading}
              style={{ background: GREEN, color: "#fff", border: "none", borderRadius: 7, padding: "0.5rem 0.85rem", fontWeight: 600, fontSize: "0.78rem", cursor: "pointer", fontFamily: "Inter,sans-serif", opacity: loading ? 0.6 : 1 }}>
              {t.chat.send}
            </button>
          </div>
        </div>
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(13,58,30,0.45)", backdropFilter: "blur(4px)", zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }} onClick={onClose}>
      <div style={{ background: "#fff", borderRadius: 16, padding: "2rem", width: "100%", maxWidth: 400, border: "1px solid #dceadc", animation: "slideUp 0.2s ease" }} onClick={e => e.stopPropagation()}>
        ...
        <button onClick={submit} disabled={loading}
          style={{ width: "100%", background: GREEN, color: "#fff", border: "none", borderRadius: 7, padding: "0.7rem", fontWeight: 600, fontSize: "0.88rem", cursor: "pointer", fontFamily: "Inter,sans-serif", opacity: loading ? 0.7 : 1 }}>
          {loading ? "..." : mode === "login" ? t.auth.loginBtn : t.auth.regBtn}
        </button>

        <button onClick={() => { setMode(m => m === "login" ? "register" : "login"); setErr(""); }}
          style={{ background: "none", border: "none", color: GREEN, fontSize: "0.79rem", cursor: "pointer", marginTop: "1rem", width: "100%", fontFamily: "Inter,sans-serif" }}>
...
export default function App() {
  ...
  async function submitBlog(form) {
    const { error } = await supabase.from("blogs").insert({
      ...
      author: form.author || "Anonymous", country: form.country,
    });
    if (error) { showToastMsg("Error submitting. Please try again."); return; }
  ...
  async function handleLogout() {
    ...
    showToastMsg(t.toast.loggedOut);
  }

  async function resendVerification() {
    if (!user) return;
    await supabase.auth.resend({ type: "signup", email: user.email });
    showToastMsg(t.toast.verifyResent);
  }

  function handleAuthSuccess(type) {
    setShowAuth(false);
    showToastMsg(type === "login" ? t.toast.loginSuccess : t.toast.regSuccess);
  }
  ...
  const filtered = problems.filter(p => {
    ...
    sort === "up" ? b.upvotes - a.upvotes :
    sort === "com" ? (comments[b.id]?.length || 0) - (comments[a.id]?.length || 0) :
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#f8faf8", color: "#1a2e1a", minHeight: "100vh" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" }}>
          ...
          {user ? (
            <div style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
              <span style={{ fontSize: "0.78rem", color: DARK, fontWeight: 600 }}>
              ...
              {isVerified
                ...
                : <button onClick={resendVerification} style={{ fontSize: "0.65rem", background: "#fff3cd", color: "#92400e", border: "1px solid #fde68a", padding: "0.08rem 0.4rem", borderRadius: 100, cursor: "pointer", fontFamily: "Inter,sans-serif" }}>{t.auth.notVerified}</button>
              }
              <button onClick={handleLogout} style={{ background: "#f8f8f8", color: "#7a9a7a", border: "1px solid #ddd", borderRadius: 6, padding: "0.35rem 0.65rem", fontFamily: "Inter,sans-serif", fontSize: "0.78rem", cursor: "pointer" }}>{t.nav.logout}</button>
            </div>
          ) : (
        ...
        <div id="problems-section" style={{ maxWidth: 1100, margin: "0 auto", padding: "1.5rem", display: "grid", gridTemplateColumns: "210px 1fr 220px", gap: "1.25rem" }}>
          ...
          <aside style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div style={{ background: "#fff", border: "1px solid #dceadc", borderRadius: 10, padding: "1rem" }}>
              ...
              <FilterBtn active={curIndustry === ""} onClick={() => setCurIndustry("")}>
                <span style={{ flex: 1 }}>{t.sidebar.all}</span><Pill>{filtered.length}</Pill>
              </FilterBtn>
      ...
      {det && (
        <Overlay onClick={() => setDetId(null)}>
          <div style={{ background: "#fff", borderRadius: 14, padding: "1.75rem", width: "100%", maxWidth: 600, border: "1px solid #dceadc", maxHeight: "90vh", overflowY: "auto" }} onClick={e => e.stopPropagation()}>
            ...
            {/* REVIEWS — only if loss >= 3000 */}
            {det.loss_amount && det.loss_amount >= 3000 && (
              <ReviewSection t={t} problemId={det.id} user={user} />
            )}
          </div>
        </Overlay>
      )}
      ...
      {/* AUTH MODAL */}
      {showAuth && <AuthModal t={t} onClose={() => setShowAuth(false)} onSuccess={handleAuthSuccess} />}
      ...
      {/* TOAST */}
      {toast && (
        <div style={{ position: "fixed", bottom: "1.5rem", right: "1.5rem", background: GREEN, color: "#fff", padding: "0.7rem 1.1rem", borderRadius: 8, fontSize: "0.84rem", fontWeight: 500, zIndex: 999, maxWidth: 300, boxShadow: "0 4px 20px rgba(26,92,48,0.25)", animation: "slideUp 0.25s ease" }}>{toast}</div>
      )}
    </div>
  );
}
...
// ── SUBMIT MODAL (with image + loss amount) ──
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(13,58,30,0.45)", backdropFilter: "blur(4px)", zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }} onClick={onClose}>
      <div style={{ background: "#fff", borderRadius: 14, padding: "1.75rem", width: "100%", maxWidth: 520, maxHeight: "90vh", overflowY: "auto", border: "1px solid #dceadc" }} onClick={e => e.stopPropagation()}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.1rem" }}>
          <div>
            <h2 style={{ fontSize: "1.1rem", fontWeight: 700, color: "#0d3a1e" }}>{t.form.title}</h2>
            <p style={{ fontSize: "0.8rem", color: "#aaa", marginTop: "0.2rem" }}>{t.form.sub}</p>
          </div>
          <button onClick={onClose} style={xBt()}>✕</button>
        </div>
